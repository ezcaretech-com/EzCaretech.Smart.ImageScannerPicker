...
namespace ImageScannerPicker.AtalasoftTwainX86Adaptor
{
    /// <summary>
    /// https://www.atalasoft.com/Products/DotImage
    /// </summary>
    public class AtalasoftTwainX86Scanner : IImageScannerPlugin
    {
        public string Name => "AtalasoftTwainX86Scanner";
        ...
        public AtalasoftTwainX86Scanner(ImageScannerConfig config)
        {
            _config = config;
        }
